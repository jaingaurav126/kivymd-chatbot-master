...
if __name__ == '__main__':
    LabelBase.register(
        name="Poppins", fn_regular=r"C:\Users\gauravja\Downloads\JordanChatBot-main\Poppins\Poppins-BoldItalic.ttf")
    LabelBase.register(
        name="BPoppins", fn_regular=r"C:\Users\gauravja\Downloads\JordanChatBot-main\Poppins\Poppins-BoldItalic.ttf")
    JordanChatBot().run()
